...
function RamBarAdministradasPorFaixaEtaria({
  ...
  const data = canvas => {
    ...
    if (window.innerWidth <= constants["l" /* RESIZE_TRESHOLD */]) {
    ...
    return {
      labels: Object.keys(graphData.labels).map(key => {
        ...
        return `${Object(utils["b" /* formatNumber */])(fromDate.getDate())}/${Object(utils["b" /* formatNumber */])(fromDate.getMonth() + 1)}`;
      }),
      datasets: [_objectSpread(_objectSpread(_objectSpread({}, constants["s" /* lineChartCommon */]), generateColor(shades[0])), {}, {
        ...
        customDose: 2,
        yAxisID: 'axis'
      }), _objectSpread(_objectSpread(_objectSpread({}, constants["s" /* lineChartCommon */]), generateColor(shades[0])), {}, {
        ...
        customDose: 1,
        yAxisID: 'axis'
      }), _objectSpread(_objectSpread(_objectSpread({}, constants["s" /* lineChartCommon */]), generateColor(tints[1])), {}, {
        ...
        customDose: 1,
        yAxisID: 'axis'
      }), _objectSpread(_objectSpread(_objectSpread({}, constants["s" /* lineChartCommon */]), generateColor(main)), {}, {
        ...
        customDose: 1,
        yAxisID: 'axis'
      }), _objectSpread(_objectSpread(_objectSpread({}, constants["s" /* lineChartCommon */]), generateColor(shades[2])), {}, {
        ...
        customDose: 1,
        yAxisID: 'axis'
      }), _objectSpread(_objectSpread(_objectSpread({}, constants["s" /* lineChartCommon */]), generateColor(complements[2])), {}, {
        ...
        customDose: 1,
        yAxisID: 'axis'
      }), _objectSpread(_objectSpread(_objectSpread({}, constants["s" /* lineChartCommon */]), generateColor(complements[1])), {}, {
  ...
  const options = () => {
    ...
    return {
      ...
      tooltips: {
        mode: 'index',
        intersect: false,
        callbacks: _objectSpread(_objectSpread(_objectSpread({}, constants["s" /* lineChartCommon */]), generateColor(shades[0])), {}, {
          label: (tooltipItem, data) => {
            var label = data.datasets[tooltipItem.datasetIndex].label;
...
function RamMapa({
  ...
  const renderMap = async map => {
    ...
    let layers = L.geoJSON(madeira, {
      onEachFeature: (feature, shape) => {
        let concelho = constants["j" /* MADEIRA_DICOS */][feature.properties.Dico];
        ...
        shape.bindPopup(`<p>
						...
						<br>1ª Dose: ${Object(utils["b" /* formatNumber */])(data.dose_1)} (${percentagem_1.toFixed(2)}%)
						</br>2ª Dose: ${Object(utils["b" /* formatNumber */])(data.dose_2)} (${percentagem_2.toFixed(2)}%)
					</p>`);
  ...
  function renderGraph(el) {
    ...
    const options = () => {
      let dico = constants["j" /* MADEIRA_DICOS */][el.chave];
        ...
        scales: {
          ...
          xAxes: [{
            ...
            ticks: {
              ...
              stepSize: Math.round(window.innerWidth <= constants["l" /* RESIZE_TRESHOLD */] ? populacao_residente / 3 : populacao_residente / 6),
              callback: value => Object(utils["b" /* formatNumber */])(value, false)
            }
          }]
        }
    ...
    return /*#__PURE__*/Object(jsx_runtime_["jsx"])(external_react_bootstrap_["Col"], {
      ...
      children: /*#__PURE__*/Object(jsx_runtime_["jsxs"])("div", {
        ...
        children: [/*#__PURE__*/Object(jsx_runtime_["jsx"])("h2", {
          ...
          height: window.innerWidth <= constants["l" /* RESIZE_TRESHOLD */] ? 60 : 60,
          options: options(),
          data: data
        })]
      })
          ...
          children: [/*#__PURE__*/Object(jsx_runtime_["jsx"])(external_react_bootstrap_["Col"], {
            ...
            children: /*#__PURE__*/Object(jsx_runtime_["jsxs"])(Card["a" /* Card */], {
              ...
              children: [/*#__PURE__*/Object(jsx_runtime_["jsx"])(Counter["a" /* Counter */], {
                ...
                children: [Object(utils["d" /* perHundred */])(selectedItem === null || selectedItem === void 0 ? void 0 : selectedItem.dose_1, generic.populacao_ram.valor).toFixed(2), " doses administradas por cada 100 pessoas", /*#__PURE__*/Object(jsx_runtime_["jsx"])("br", {}), Object(utils["b" /* formatNumber */])((selectedItem === null || selectedItem === void 0 ? void 0 : selectedItem.dose_1) - (selectedItem === null || selectedItem === void 0 ? void 0 : selectedItem.dose_2)), " pessoas inoculadas com a 1\xAA dose"]
              })]
            })
          }), /*#__PURE__*/Object(jsx_runtime_["jsx"])(external_react_bootstrap_["Col"], {
            lg: 4,
            ...
            children: /*#__PURE__*/Object(jsx_runtime_["jsxs"])(Card["a" /* Card */], {
              ...
              children: [/*#__PURE__*/Object(jsx_runtime_["jsx"])(Counter["a" /* Counter */], {
                ...
                class: Card_module_default.a.card_subtitle,
                children: [Object(utils["d" /* perHundred */])(selectedItem === null || selectedItem === void 0 ? void 0 : selectedItem.dose_2, generic.populacao_ram.valor).toFixed(2), " doses administradas por cada 100 pessoas", /*#__PURE__*/Object(jsx_runtime_["jsx"])("br", {}), Object(utils["b" /* formatNumber */])(selectedItem === null || selectedItem === void 0 ? void 0 : selectedItem.dose_2), " pessoas inoculadas com a 2\xAA dose"]
              })]
            })
          })]
        }), /*#__PURE__*/Object(jsx_runtime_["jsxs"])(external_react_bootstrap_["Row"], {
      ...
      tooltips: {
        callbacks: {
          label: function ({
            ...
            return `${label}: ${Object(_utils__WEBPACK_IMPORTED_MODULE_6__[/* formatNumber */ "b"])(data)}`;
          }
        }
      }
    };
...
function LineRt({
  ...
  const data = canvas => {
    ...
    let {
      ...
      g,
      b
    } = Object(_utils__WEBPACK_IMPORTED_MODULE_4__[/* hexToRgb */ "c"])(main);
    ...
    return {
      ...
      datasets: [_objectSpread(_objectSpread({}, _constants__WEBPACK_IMPORTED_MODULE_3__[/* lineChartCommon2 */ "t"]), {}, {
        ...
        order: 1,
        yAxisID: 'rt'
      }), _objectSpread(_objectSpread({}, _constants__WEBPACK_IMPORTED_MODULE_3__[/* lineChartCommon */ "s"]), {}, {
        label: 'R(t)',
        backgroundColor: main,
        borderColor: main,
        type: 'line',
        ...
        order: 2,
        yAxisID: 'rt'
      }), _objectSpread(_objectSpread({}, _constants__WEBPACK_IMPORTED_MODULE_3__[/* lineChartCommon2 */ "t"]), {}, {
...
module.exports = JSON.parse("{\"date\":1617227154468,\"dateSnsStartWeirdFormat\":\"22/03/2021\",\"dateSnsStart\":\"2021-03-22T00:00:00\",\"dateSns\":\"2021-03-28T00:00:00\",\"dateEcdc\":\"2021-03-14\",\"dateRt\":\"20210-03-13\",\"dateMadeira\":\"2021-03-28\",\"dateMadeiraCases\":\"2021-03-30\"}");
